      ...
      <div className="card card-side bg-base-100  mt-20">
        <div className="card-body w-[40rem] pt-20 mt-10">
          <h3 className="text-xl justify-center">
            Our volunteer are doing so much more than just delivering nutritious
            meals - they provide social interactions for who may be isolated or
            homebound. Our volunteers also conduct critical safety checks while
            dropping off meals.
          </h3>
        ...
        <figure className="w-[60rem]">
          <img src={Working} alt="Wheels Driver" />
        </figure>
      </div>

      <div class="card card-side bg-base-100 mt-20 flex justify-center space-x-20">
        <div>
          <figure className="w-80 h-50 p-2">
            <img src={WheelsDriver} alt="Wheels Driver" />
          </figure>
        ...
        <div>
          <figure className="w-80 h-50 p-2">
            <img src={WellnessCheck} alt="Wheels Driver" />
          </figure>
          <div className="figure-content text-center text-content">
            <div className="max-w-md">
        ...
        <div>
          <figure className="w-80 h-50  p-2">
            <img src={FriendlyText} alt="Friendly Chat" />
          </figure>
          <div className="figure-content text-center text-content">
            <div className="max-w-md">
